...
const Productos = () => {
  ...
  const Loading = () => {
    return (
      <div className="buttons d-flex justify-content-center mb-5 pb-5">Cargando...</div>
    );
  };
          ...
          <section className="col-md-3 mb-4" key={product.id}>
            <div className="card h-100 text-center p-4">
              ...
              <div className="card-body">
                ...
                <Link className="btn btn-outline-dark ms-2" href="./product/[id]" as={`/product/${product.id}`}>COMPRAR</Link>
              </div>
            </div>
          </section>
        ))}
    ...
    <section className="container my-5 py-5">
      <section className="row">
        <section className="col-12 mb-5">
          <h1 className="display-6 fw-bolder text-center">LOS MEJORES PRODUCTOS</h1>
          <hr />
        </section>
      </section>
